...
public class SideMenuButtonMouseEnteredHandler implements EventHandler<MouseEvent> {
    private final SideMenuDashboardController controller;
    private final Button button;

    public SideMenuButtonMouseEnteredHandler(
    ...
    public void handle(MouseEvent event) {
        controller.handleMouseEntered(button);
    }
}
